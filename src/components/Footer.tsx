...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/5 pt-24 pb-12 bg-black/40 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="flex gap-4">
              {socialIcons.map((social, idx) => (
                <Link 
                  key={idx} 
                  href={social.href} 
                  className="p-2 glass rounded-lg text-white/60 hover:text-white transition-all hover:scale-110 active:scale-95"
